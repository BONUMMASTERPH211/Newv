...
module.exports = {
  ...
  async execute(bot, args, authToken, event) {
    ...
    if (!finalPrompt) {
      return sendMessage(bot, { text: "passport po Please enter your question or reply with an image to analyze." }, authToken);
    }
...
Newv/cmds/ai.js at master · BONUMMASTERPH211/Newv 
